# Experiment 3: first model, with ReLU and Tanh activations
...
model_args=( '[128,[1024],10]' )
model_kwargs=( '{"output_activation":nn.Softmax, "activation_function":nn.ReLU}' '{"output_activation":nn.Softmax, "activation_function":nn.Tanh}' )
...
rm_args=( '[]' )
rm_kwargs=( '{}' )
rm_distributions=( '"MultivariateNormal"' )
rm_source_dims=( 2 )
